                ...
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${
                      user.role.toUpperCase() === ROLES.ADMIN ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                    }`}>
                      {ROLE_DISPLAY_NAMES[user.role.toUpperCase() as keyof typeof ROLE_DISPLAY_NAMES]}
                    </span>
                  </td>
